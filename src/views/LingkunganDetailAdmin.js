  ...
  return (
    <>
      <Container className="my-5 pt-5">
        {/* Header Section */}
        <h1 className="mb-4 text-center">{kegiatan.title}</h1>
        ...
        <Row>
          <Col md={8} className="mx-auto">
            ...
            <section className="mb-4">
              ...
              <p style={{ fontSize: "1.1rem", lineHeight: "1.8" }}>{kegiatan.description}</p>
            </section>

            {/* Jadwal Kegiatan */}
            <section className="mb-4">
              <h4>Jadwal Kegiatan</h4>
              <p style={{ fontSize: "1.1rem" }}>{kegiatan.schedule}</p>
            </section>

            {/* Informasi Tambahan */}
            <section className="mb-4">
              <h4>Informasi Tambahan</h4>
              <p style={{ fontSize: "1.1rem", lineHeight: "1.8" }}>{kegiatan.additionalInfo}</p>
            </section>
            ...
            <section className="mb-4">
              <h4>Alamat Lokasi</h4>
              <p style={{ fontSize: "1.1rem" }}>{kegiatan.locationAddress}</p>
              {/* Google Maps Embed */}
