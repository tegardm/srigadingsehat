...
const LingkunganTambah = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        dusun: namadusun || '', // Default value from params, or empty string
        locationAddress: '',
        locationGmaps: '',
        thumbnail: '',
    });
            ...
            uploadTask.on(
                ...
                async () => {
                    try {
                        ...
                        await addDoc(collection(db, 'lingkungans'), {
                            ...formData,
                            thumbnail: url,
                        });
        ...
        <>
            ...
            <Container className="mt-4">
                <Card className="p-4 shadow-sm">
                    <h4 className="text-center mb-4">Tambah Informasi Kegiatan Lingkungan Desa</h4>
...
export default LingkunganTambah;
